...
@section('content')
            ...
            <section class="py-5">
                <div class="container px-4 px-lg-5 my-5">
                    <div class="row gx-4 gx-lg-5 align-items-center">
                        <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="{{ Storage::url($data->image) }}"
                                alt="..." /></div>
                        <div class="col-md-6">
                            <div class="small mb-1">Số lượng: {{ $data->quantity }}</div>
                            <h1 class="display-5 fw-bolder">{{ $data->product_name }}</h1>
                            <div class="fs-5 mb-5">
                                @if ($data->sale == 1)
                                    <span class="text-muted text-decoration-line-through">{{ $data->price }}đ</span>
                                    {{ $data->price - $data->price * (10 / 100) }}đ
                                @else
    ...
    <div class="why-choose-section bg-Info  ">
        <div class="container ">
            <div class="row">
